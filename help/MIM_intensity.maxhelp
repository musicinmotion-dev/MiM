...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 453.0, 29.0, 159.0, 101.163749999999993 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 416.49999274999999, 217.0, 155.000000000000057, 33.0 ],
					"text" : "Default values on load is for the use uf gyration data."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 416.49999274999999, 168.0, 87.0, 22.0 ],
					"text" : "loadmess 0.97"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 510.499992750000047, 168.0, 80.0, 22.0 ],
					"text" : "loadmess 0.8"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 103.0, 393.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 33.0, 55.0, 222.0, 49.0 ],
					"text" : "MiM_intensity",
					"varname" : "HelpTitle"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 72.875, 207.0, 359.5, 207.0 ],
					"source" : [ "obj-1", 1 ]
				}
